...
$year=$_POST['year'];
$sql = "SELECT * FROM workshop where year='$year' and events='guestlectures'";
$i=1;
    ...
    if(mysqli_num_rows($result) > 0){
	   ...
	   echo "<table border='1'>";
            echo "<tr>";
			    ...
			    echo "<th>guestlecture name</th>";
                echo "<th>start_date</th>";
				echo "<th>end_date</th>";
				echo "<th>guestname1</th>";
				echo "<th>guestname2</th>";
                echo "<th>facultycoordinators1</th>";
				echo "<th>facultycoordinators2</th>";
