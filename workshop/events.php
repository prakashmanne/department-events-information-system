				...
				<ul>
					<li>
						<div class="banner-top2">
							<div class="container">
								<div class="w3layouts-banner-info text-left">
								
								<a href="workshop.php" align="left"><br><font style="color:white"><h2> WORKSHOP</h2></font>
								<a href="conference.php"><br><font style="color:white"><h2>CONFERENCE</h2></font>
								<a href="guestlecture.php"><br><font style="color:white"><h2>GUESTLECTURE</h2></font>
								<a href="seminar.php"><br><font style="color:white"><h2>SEMINAR</h2></font>
								<a href="fdp.php"><br><font style="color:white"><h2>FDP</h2></font>									
								</div>
							</div>
						</div>
					</li>
