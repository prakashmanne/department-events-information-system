...
<form action="guestlecture1.php" method="post" enctype="multipart/form-data">
<table border="1", height="30%" width="30%"   align="center">
<div class="form-group">
<h2><tr><h2><label for=""> SELECT YEAR </label>
<td><select name="year" class="form-control">
<option value="select">select</option>
<option value="2016-2017">2016-2017</option>
<option value="2017-2018">2017-2018</option>
<option value="2018-2019">2018-2019</option></td></h2></tr>
<tr>
<h2><td><button type="submit" name="submit" class="btn btn-primary">search</button></h2></tr>
